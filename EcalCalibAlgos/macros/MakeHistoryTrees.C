                        ...
                        OUTT eb_ratio, vector<double>& etSumEB, map<int, vector<double> >& etSumPN)
{
    ...
    for(int i=0; i<61200; ++i)
    {
        ...
        { 
            ...
            eb_ratio->n_hits[iV-ref] = eb_iovs[iV]->rec_hit->GetNhits(); 
	    ...
	    //            eb_ratio->mean_bs_sigmaz[iV-ref] = eb_iovs[iV]->mean_bs_sigmaz; 
            ...
            eb_ratio->ic_hr_ratio_eflow[iV-ref] = eb_iovs[iV]->ic_hr_eflow/eb_iovs[ref]->ic_hr_eflow; // Eflow
            eb_ratio->ic_5x5_ratio_eflow[iV-ref] = eb_iovs[iV]->ic_5x5_eflow/eb_iovs[ref]->ic_5x5_eflow; // Eflow
            ...
            eb_ratio->k_hr_ratio_abs[iV-ref] = eb_iovs[iV]->k_hr/eb_iovs[ref]->k_hr;  //new k
            eb_ratio->k_5x5_ratio_abs[iV-ref] = eb_iovs[iV]->k_5x5/eb_iovs[ref]->k_5x5; //new k
                        ...
                        OUTT ee_ratio, vector<double>& etSumEB, map<int, vector<double> >& etSumPN)
{
    ...
    { 
        ...
        { 
            ...
            ee_ratio->n_hits[iV-ref] = ee_iovs[iV]->rec_hit->GetNhits(); 
            ee_ratio->avg_time[iV-ref] = ee_iovs[iV]->avg_time; 
            ee_ratio->firstRun[iV-ref] = ee_iovs[iV]->firstRun; 
            ee_ratio->lastRun[iV-ref] = ee_iovs[iV]->lastRun;         
            ee_ratio->firstLumi[iV-ref] = ee_iovs[iV]->firstLumi; 
            ee_ratio->lastLumi[iV-ref] = ee_iovs[iV]->lastLumi;   
            ...
            ee_ratio->ring_average[iV-ref] = ee_iovs[iV]->ring_average; 
            ee_ratio->ring_average_uncleaned[iV-ref] = ee_iovs[iV]->ring_average_uncleaned; 
            ...
            ee_ratio->ic_ratio_eflow[iV-ref] = ee_iovs[iV]->ic_eflow/ee_iovs[ref]->ic_eflow; // Eflow
